    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const response =  await axios.put("http://localhost:1417/aboutus", user);
      ...
      // Optional: alert(response.data.message);
    } catch (error) {
                          ...
                          <div className="col-md-12 col-12">
                            <div className="mb-2">
                              <label className="form-label" htmlFor="blog-edit-title">
                                Title</label>
                              <input type="text" id="blog-edit-title" className="form-control" name="title"
                                value={user.title} readOnly onChange={(e) => setUser({ ...user, title: e.target.value })}/>
                            </div>
                          </div>
                          <div className="col-12">
                            <div className="mb-2">
